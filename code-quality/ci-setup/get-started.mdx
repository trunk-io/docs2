...
Sign up at [app.trunk.io](https://app.trunk.io/signup?intent=code%20quality), create a Trunk organization, and connect it to your repositories. You will need to grant the following [GitHub App permissions](/setup/integrations/github/trunk-app).
...
![](/assets/code-quality/ci-setup/image_(35).png)
</Frame>
...
![](/assets/code-quality/ci-setup/Screenshot_2023-08-23_173119.png)
</Frame>
...
![](/assets/code-quality/ci-setup/Screenshot_2023-08-23_173252.png)
</Frame>
