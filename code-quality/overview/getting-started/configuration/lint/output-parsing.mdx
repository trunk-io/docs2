...
Note that you can also set `parser.runtime` to [`node`](../runtimes) or [`python`](../runtimes) so that you can write your parser in Javascript or Python instead, if you so prefer! You can find plenty of examples of python parsers in our [plugins repo](https://github.com/trunk-io/plugins).
