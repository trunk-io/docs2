...
If you **only want to prevent new issues** from new code changes, skip to [prevent-new-issues](./prevent-new-issues/).
...
When you've fixed the existing issues you want to fix, you can skip to [prevent-new-issues](./prevent-new-issues/) directly.
