...
description: "Switch from GitHub's native merge queue to Trunk Merge Queue with minimal disruption to your workflow."
---
...
Now that you have migrated to Trunk Merge Queue, be sure to share the workflow with your team — [Using the Queue](./using-the-queue/) is a great place to start.
