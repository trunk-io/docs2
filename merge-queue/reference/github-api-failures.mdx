...
3. If GitHub's status is green and the failure keeps happening, contact [support@trunk.io](mailto:support@trunk.io) with a link to the affected PR.
...
**If this keeps happening:** contact [support@trunk.io](mailto:support@trunk.io) with a link to the affected PR. This error comes from GitHub's side, and we can raise repeated occurrences with GitHub.
...
3. If the failure persists, contact [support@trunk.io](mailto:support@trunk.io) with a link to the affected PR. Rate limits apply org-wide and you can't easily see what's consuming them — we can help figure out whether the queue's own activity, other automation, or something on GitHub's side is responsible.
