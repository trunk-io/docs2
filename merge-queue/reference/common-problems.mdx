...
og:title: "Trunk Merge Queue FAQ"
---
...
<Accordion title="Why does my pull request keep failing to merge in the queue?">
  ...
  that you have **disabled squash merges** into your repo. Trunk Merge Queue
  needs to use squash merges. To fix this, turn on `'allow squash merges'` for
  this repo in your GitHub setup.
</Accordion>
