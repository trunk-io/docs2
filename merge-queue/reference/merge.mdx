...
<CardGroup cols={2}>
  ...
  <Card title="Get several submitted pull requests from a merge queue" href="/merge-queue/reference/merge/get-several-submitted-pull-requests-from-a-merge-queue"/>
  ...
  <Card title="List completed merge queue testing for a time range" href="/merge-queue/reference/merge/list-completed-merge-queue-testing-for-a-time-range"/>
</CardGroup>
