...
description: "Submit, cancel, and track Trunk Merge Queue pull requests directly from GitHub with the Trunk browser extension for Chrome and Firefox. Optionally shows Flaky Tests results inline on the PR page."
