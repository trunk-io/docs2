...
Trunk Merge Queue layers three things on top of that baseline:
...
<Columns cols={3}>
  ...
  <Tile
    ...
    description="Flakes don't evict PRs."
  >
    <Icon icon="shield-check" size={48} />
  </Tile>
</Columns>

Each links to the deep page with mechanics and worked examples. The rest of this page maps the same three to symptoms you'd recognize on your own team.
