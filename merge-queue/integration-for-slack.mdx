...
og:title: "Slack integration for Trunk Merge Queue"
---
...
<Frame>
![](/assets/merge-queue/slack-multi-channel.png)
</Frame>
...
<Frame caption="Screen to connect Slack to your workspace">
![](/assets/merge-queue/slack-workspace-connect.png)
</Frame>

<Frame caption="Slack's OAuth authorization screen for the Trunk app">
![](/assets/merge-queue/slack-workspace-oauth.png)
</Frame>

<Frame caption="Trunk's UI after the Slack app has been connected">
![](/assets/merge-queue/slack-workspace-connected.png)
</Frame>
...
<Frame caption="An example where all Merge Queue notifications go to one channel, and failures are routed to a dedicated channel for higher visibility.">
![](/assets/merge-queue/slack-multiple-channels.png)
</Frame>
...
* The Trunk Slack app must be [installed for your organization](./integration-for-slack#installing-the-trunk-slack-app) before personal notifications can be configured. If the app hasn't been installed yet, the Home tab will display a warning directing a Slack admin to complete the installation.
* Your personal GitHub account must be linked to your Trunk account. Without it, Trunk can't match pull requests to you, and you'll receive only Merge Queue updates. See [Personal Notifications](../setup-and-administration/personal-notifications#connect-your-github-account).
</Note>
...
<Frame>
![](/assets/merge-queue/slack-home-connect.png)
</Frame>
...
<Frame>
![](/assets/merge-queue/slack-dm-start-connection.png)
</Frame>
...
<AccordionGroup>
<Accordion title="Do I need both GitHub and Slack connected to receive personal notifications?">
...
<Accordion title="What's the difference between personal notifications and channel notifications?">
...
<Accordion title="What happens if I disconnect my Slack account from my Trunk account?">
...
<Accordion title="I don't see the Trunk app in my Slack sidebar. How do I add it?">
...
<Frame>
![](/assets/merge-queue/slack-notification-topics.png)
</Frame>
