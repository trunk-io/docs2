...
3. In the **Add Slack Channel** modal, paste your Slack channel link. To get the link: right-click the channel name in Slack and choose **Copy link**. Trunk looks up the channel and displays its name when found.
