...
<Frame caption="Merge Queue settings are split into General, GitHub, Slack, Batching, and Sudo sections in the sidebar, each with its own URL.">
...
<Frame caption="The GitHub section of Merge Queue settings. Required Statuses, opened with Configure, is where you pick the CI checks the queue waits on.">
