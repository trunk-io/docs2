...
Toggle this setting in **Settings** > **Repositories** > your repository > **Merge Queue**. Learn more in [Direct Merge to Main](../optimizations/direct-merge-to-main).
...
<Frame>
![](/assets/merge-github-comment_(1).png)
</Frame>
