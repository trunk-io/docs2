...
description: "Trunk Merge Queue tests pull requests against the projected future state of your main branch, not just the current state.&x20;"
---
### What it is
...
<Card title="Watch demo" icon="play" href="https://share.vidyard.com/watch/31gaLwGNSYTn2ec2BSQjkn">
