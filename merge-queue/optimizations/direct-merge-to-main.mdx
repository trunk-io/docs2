---
title: "Direct merge to main"
description: "Direct Merge to Main is an optimization that allows PRs to merge immediately without waiting in the queue when retesting would provide no value."
---
### Overview
...
<figure><img src="https://577236045-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F61Ep9MrYBkJa0Yq3zS1s%2Fuploads%2FNnzdtwCqrWflL3PRT5Rs%2F1768426934-direct-merge-mode-toggle.avif?alt=media&#x26;token=42df9376-f60d-405a-84c3-31f5ad518624" alt="" /><figcaption></figcaption></figure>
...
**In** [**Slack notifications**](/merge-queue/integration-for-slack) **(if configured):**
...
[**Predictive Testing**](/merge-queue/optimizations/predictive-testing)
...
[**Optimistic Merging**](/merge-queue/optimizations/optimistic-merging)
...
[**Batching**](/merge-queue/optimizations/batching)
...
[**Parallel Queues**](/merge-queue/optimizations/parallel-queues)
