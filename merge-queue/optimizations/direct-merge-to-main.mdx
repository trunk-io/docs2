...
description: "Skip redundant retesting and merge PRs directly when they are already tested against the current tip of main."
og:title: "Direct merge to main in Trunk Merge Queue"
---
## Overview
...
<Frame>
![](/assets/merge-queue/optimizations/1768426934-direct-merge-mode-toggle.avif)
</Frame>
...
<AccordionGroup>
<Accordion title="Why didn't my PR merge directly?">
...
<Accordion title="Does this bypass security checks?">
...
<Accordion title="Will this slow down other PRs?">
...
<Accordion title="What if tests are flaky?">
