...
<img className="block dark:hidden" src="/assets/enable-parallel-mode-light.png" alt="Enabling parallel mode in the Merge Queue Mode settings" />
<img className="hidden dark:block" src="/assets/enable-parallel-mode-dark.png" alt="Enabling parallel mode in the Merge Queue Mode settings" />
</Frame>
