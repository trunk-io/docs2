---
title: "Priority merging"
description: "Fast-track critical PRs like hotfixes and security patches to the front of the merge queue."
og:title: "Priority merging in Trunk Merge Queue"
---
## What it is
...
<Frame caption="The full sequence: a HIGH PR slots in behind the PRs already testing, then an URGENT PR preempts the front and the displaced test restarts.">
<img src="/assets/merge-queue/optimizations/priority-merging.svg" alt="A merge queue where a HIGH priority PR slides in ahead of pending PRs without interrupting the testing PR, then an URGENT PR takes the front and the front test restarts." />
</Frame>

Say you have a queue that is configured to test two PRs at once. **A** and **B** are currently testing, and **C** is pending behind them.
...
<Frame caption="A HIGH priority D slots in ahead of pending C without interrupting the PRs already testing.">
<img src="/assets/merge-queue/optimizations/priority-merging-high.svg" alt="Queue with A and B testing and a new higher priority PR D placed ahead of pending C." />
</Frame>
...
<Frame caption="An URGENT D preempts the front: D and A test, the displaced B drops back to pending behind C.">
<img src="/assets/merge-queue/optimizations/priority-merging-urgent.svg" alt="Queue with an urgent PR D moved to the front and testing alongside a restarted A, while B is bumped back to pending." />
</Frame>
