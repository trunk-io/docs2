...
<Frame>
<img src="/assets/merge-queue/optimizations/file.excalidraw.svg" alt="Queue with two testing PRs and one pending" class="gitbook-drawing"/>
</Frame>
...
<Frame>
<img src="/assets/merge-queue/optimizations/file.excalidraw_(8).svg" alt="Queue with two testing PRs and a new higher priority pending PR" class="gitbook-drawing"/>
</Frame>
...
<Frame>
<img src="/assets/merge-queue/optimizations/file.excalidraw_(1).svg" alt="Queue with an urgent PR moved to the front and a normal PR restarting" class="gitbook-drawing"/>
</Frame>
