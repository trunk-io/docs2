...
description: "Set up GitHub branch protection so Trunk Merge Queue can admit, test, and merge pull requests through your protected branch."
og:title: "Configure branch protection for Trunk Merge Queue"
---
...
The configurations on this page (push restrictions for the `trunk-io` bot, and excluding `trunk-temp/**/*` and `trunk-merge/**/*` from protection) ensure branch protection doesn't _block_ Trunk from doing its job. They don't change either of the roles above.
...
<a id="ruleset-1-branch-update"></a>
...
<Frame caption="Ruleset #1: Trunk on the bypass list as Exempt so it can update main.">
  ![GitHub ruleset with Restrict updates and Restrict deletions enabled,
  Trunk.io and Trunk Sudo on the bypass list as
  Exempt](/assets/merge-queue/getting-started/merge-github-ruleset-push.png)
</Frame>
...
<a id="ruleset-2-mergeability-requirements"></a>
...
<Frame caption="Ruleset #2: Trunk is not on the bypass list, so the queue respects these requirements when admitting PRs.">
  ![GitHub ruleset with Require a pull request before merging and Require status
  checks to pass enabled, Trunk.io not on the bypass
  list](/assets/merge-queue/getting-started/merge-github-ruleset-prs.png)
</Frame>
...
<a id="exempt-trunk-temporary-branches"></a>
...
<Frame caption="Add `trunk-temp/**/*` and `trunk-merge/**/*` as exclude patterns on any Branch ruleset whose targeting could otherwise match them.">
  <img
    src="/assets/merge-queue/getting-started/branch-ruleset-exclusions.png"
    alt="GitHub Branch targeting criteria with All branches included and trunk-temp/**/* and trunk-merge/**/* listed as exclude patterns"
  />
</Frame>

<a id="verify-your-ruleset-configuration"></a>
...
<Frame>
  ![](/assets/merge-queue/getting-started/merge-github-classic-branch-rules.png)
</Frame>
...
<a id="verify-your-classic-configuration"></a>
...
_Having trouble?_ See our [Troubleshooting guide](../reference/troubleshooting) for common installation issues.
