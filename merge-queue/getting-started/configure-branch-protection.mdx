...
* Define required status checks in your `.trunk/trunk.yaml` [configuration file](/merge-queue/getting-started/configure-ci-status-checks#if-using-draft-pr-mode-default)
...
<figure><img src="https://577236045-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F61Ep9MrYBkJa0Yq3zS1s%2Fuploads%2Fgit-blob-c35af902e3f1814b89adde24f3ab0b04b8b3b137%2Fmerge-github-classic-branch-rules.png?alt=media" alt="" /><figcaption></figcaption></figure>
...
→ [**Configure CI status checks**](/merge-queue/getting-started/configure-ci-status-checks) **-** Configure CI status checks for your branch.
