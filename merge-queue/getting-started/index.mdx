...
<Note>
**You must be a GitHub admin to complete the following steps.** If you are not a GitHub admin in your organization, navigate to **Settings** → **Team Members** to invite a GitHub admin to your Trunk organization so they can complete the following.
...
<Frame>
![](/assets/merge-github-comment.png)
</Frame>
