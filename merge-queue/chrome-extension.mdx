...
| **Trunk bot comments** | Trunk bot comments that prompt you to submit a PR to the merge queue (for example, "To merge this pull request, check the box" or a comment containing a `/merge-queue/` link) | On |
