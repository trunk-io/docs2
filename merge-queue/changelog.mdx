...
<Update label="June 3, 2026" tags={["Merge Queue"]}>
  **[Merge Queue: Chrome Extension Terminal State Improvements](/changelog/2026-06-03-merge-queue-chrome-extension-terminal-states)**

  Failed and cancelled queue items now show structured details and a resubmit button directly in the extension panel.
</Update>
