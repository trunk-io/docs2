...
To enable GitHub status checks, go to [**GitHub Statuses**](../../merge-queue/administration/advanced-settings#github-statuses) in **Merge Queue** → **[your repository]** → **Settings**. This is a per-queue setting and is enabled by default.
