...
To enable GitHub status checks, click [**GitHub Statuses**](../../merge-queue/administration/advanced-settings#github-statuses) in **Merge Queue** → **[your repository]** → **Settings** → **GitHub**. This is a per-queue setting and is enabled by default.
...
<Frame caption="Clicking on a queue item navigates you to the details page.">
![](/assets/merge-queue/using-the-queue/merge-queue-screen.png)
</Frame>
...
<Frame caption="PR readiness details for a PR that has been submitted but has not yet entered the merge queue.">
![](/assets/merge-queue/using-the-queue/merge-details_(1).png)
</Frame>
