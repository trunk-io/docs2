...
To enable GitHub status checks, click [**GitHub Statuses**](../../merge-queue/administration/advanced-settings#github-statuses) in **Merge Queue** → **[your repository]** → **Settings**. This is a per-queue setting and is enabled by default.
