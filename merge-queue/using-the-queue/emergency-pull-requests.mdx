...
description: "Bypass the merge queue entirely for true emergencies. Use with caution as this can invalidate in-progress queue tests."
og:title: "Emergency pull requests in Trunk Merge Queue"
---
