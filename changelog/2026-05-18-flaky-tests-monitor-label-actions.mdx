...
When you create or edit a [pass-on-retry](/flaky-tests/detection/pass-on-retry-monitor), [failure rate](/flaky-tests/detection/failure-rate-monitor), or [failure count](/flaky-tests/detection/failure-count-monitor) monitor, the **Action** section now offers:
...
[Read the docs](/flaky-tests/management/test-labels#automatic-labeling-from-monitors) to learn more.
