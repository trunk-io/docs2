...
The [Trunk browser extension](https://chromewebstore.google.com/detail/trunk-for-github/liggeliamkammmieidmmfmmdnjilabgn?utm_source=changelog) is graduating from beta with version 1.0.0.
...
<img
  src="/assets/changelog/browser-extension-1-0-submit-menu-v2.png"
  alt="The Trunk browser extension's Add to merge queue menu, with Regular priority and Direct to Queue options"
/>
...
<Note>
  **Action required for existing Chrome users:** Version 1.0.0 requests access to additional forge domains as we prepare to bring Trunk Merge Queue beyond GitHub. Chrome may disable the extension after updating and ask you to approve the new permissions. Accept the prompt to re-enable the extension.
</Note>
