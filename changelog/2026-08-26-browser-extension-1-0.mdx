...
<Frame>
  <img src="/assets/changelog/browser-extension-1-0-submit-menu.png" alt="The Trunk browser extension's Add to merge queue menu, with Regular priority and Direct to Queue options" />
</Frame>
