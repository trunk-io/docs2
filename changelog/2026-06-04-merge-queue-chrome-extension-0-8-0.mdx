...
![The Hide rows settings card in the Trunk extension popup, with toggles for Merging is blocked, Branch out of date, and Trunk (bot) GitHub Comments](/assets/changelog/merge-queue-chrome-extension-0-8-0-hide-rows.png)
