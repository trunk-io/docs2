...
<Update label="June 29, 2026" tags={["Merge Queue"]}>
  **[Browser Extension: Performance and bug fixes](/changelog/2026-06-29-browser-extension-0-13-0)**
  ...
  Version 0.13.0 of the Trunk browser extension ships faster PR page rendering, lower memory usage on long-running tabs, and fixes for stale data, small-viewport layout, and intermittent test result fetches.
</Update>
