...
<Update label="September 18, 2026" tags={["Weekly Roundup"]}>
  **[Weekly roundup: Workspaces preview, Merge Queue APIs and metrics, v2 Test Cases refresh](/changelog/2026-09-18-weekly-roundup)**

  Trunk Workspaces enters private preview, Merge Queue picks up new API endpoints and a per-state duration metric, and the v2 Test Cases API response is refreshed.
</Update>
