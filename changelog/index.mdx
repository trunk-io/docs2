...
<Update label="September 18, 2026" tags={["Merge Queue", "Flaky Tests"]}>
  **[Weekly roundup: Merge Queue metrics and API expansions](/changelog/2026-09-18-weekly-roundup)**

  New per-state duration metric for Merge Queue, expanded Merge Queue API for bulk PR reads and discovery, and a v2 Test Cases API response refresh.
</Update>
