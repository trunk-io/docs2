...
<Update label="June 22, 2026" tags={["Merge Queue"]}>
  **[Merge Queue: Browser Extension Reliability Fix for Expired Sessions](/changelog/2026-06-22-merge-queue-browser-extension-reliability)**

  The Trunk browser extension no longer floods network requests when your session cookie has expired or become invalid.
</Update>
