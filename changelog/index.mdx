...
<Update label="June 24, 2026" tags={["Merge Queue"]}>
  **[Merge Queue: Browser Extension Auth Stability Improvements](/changelog/2026-06-24-merge-queue-browser-extension-auth-stability)**

  The extension no longer enters a request loop on stale or expired sessions, and now enforces a client-side GraphQL rate limit.
</Update>
