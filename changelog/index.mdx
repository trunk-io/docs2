...
<Update label="June 2, 2026" tags={["Merge Queue"]}>
  **[Merge Queue: Chrome Extension Terminal State UI](/changelog/2026-06-02-merge-queue-chrome-extension-terminal-states)**

  The Chrome Extension now shows structured terminal states for failed, cancelled, and merged pull requests, with resubmit flows and a waiting-to-batch indicator.
</Update>
