...
<Update label="June 24, 2026" tags={["CI Autopilot"]}>
  **[CI Autopilot: Event Cards in CI Monitors Link to SHA-Filtered Job Detail](/changelog/2026-06-24-ci-autopilot-ci-monitors-event-links)**

  Event cards in the CI Monitors Events Panel now link to the CI job detail page pre-filtered by commit SHA and branch.
</Update>
