...
<Update label="September 18, 2026" tags={["Merge Queue"]}>
  **[Merge Queue: Direct to Queue](/changelog/2026-09-18-merge-queue-direct-to-queue)**

  Admins can send a pull request straight to the queue when branch protection isn't satisfied — tests still run, only the final merge bypasses protection.
</Update>
