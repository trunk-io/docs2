...
<Update label="May 26, 2026" tags={["Merge Queue"]}>
  **[Merge Queue: Test CI Workflow](/changelog/2026-05-26-test-ci-workflow)**

  Dummy entry to verify the changelog-check GitHub Action catches nav drift.
</Update>
