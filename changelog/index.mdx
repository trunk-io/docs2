...
<Update label="June 24, 2026" tags={["CI Autopilot"]}>
  **[CI Autopilot: Create, Edit, and Delete CI Pass-on-Retry Monitors](/changelog/2026-06-24-ci-autopilot-ci-monitors-crud)**

  You can now create, edit, and delete CI Pass-on-Retry monitors directly from the Monitors tab.
</Update>
