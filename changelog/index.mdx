...
<Update label="June 8, 2026" tags={["Merge Queue"]}>
  **[Merge Queue: Connect Slack Channels by Pasting a Link](/changelog/2026-06-08-merge-queue-slack-channel-url-picker)**

  The Add Slack Channel dialog now accepts a pasted channel link instead of a searchable dropdown, fixing failures for workspaces with large channel counts.
</Update>
