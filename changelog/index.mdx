...
<Update label="September 23, 2026" tags={["Merge Queue"]}>
  **[Merge Queue: Browser extension 1.2, richer webhooks, API, and metrics](/changelog/2026-09-23-merge-queue-september-updates)**

  The browser extension says why a PR can't enter the queue and shows queue state across GitHub, while webhooks, the API, and Prometheus metrics now explain where each PR is and why.
</Update>

<Update label="September 23, 2026" tags={["Web App"]}>
  **[Web App: Organization-wide AI features switch](/changelog/2026-09-23-web-app-ai-features-switch)**

  Admins can now turn off every AI feature across Trunk for their organization with a single setting.
</Update>

<Update label="September 23, 2026" tags={["Web App"]}>
  **[Web App: New navigation, the CI tab, and guided setup](/changelog/2026-09-23-web-app-new-navigation-and-ci)**

  A new sidebar makes room for the CI tab, which brings performance and flaky monitoring to your GitHub Actions workflows, and a new onboarding flow walks you through setting it all up.
</Update>

<Update label="September 22, 2026" tags={["Flaky Tests"]}>
  **[Flaky Tests: Copy monitors between collections](/changelog/2026-09-22-flaky-tests-collection-monitor-tools)**

  Copy flake detection monitors from one test collection to another, skip the default monitors on a new collection, and load the Tests table without waiting on ticket data.
</Update>
