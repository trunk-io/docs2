...
![AI flaky-test investigation result delivered to Slack via webhook](/assets/changelog/flaky-tests-ai-investigations-webhooks-mock.png)
...
[Read the docs](/flaky-tests/webhooks#testcaseinvestigationcompleted) to learn more.
