...
![GitHub ruleset bypass list with Trunk Sudo set to Exempt](/assets/trunk-sudo-ruleset-bypass-mode.png)
</Frame>
...
![Trunk Sudo setup checklist in the Merge Queue settings page](/assets/trunk-sudo-setup-checklist.png)
</Frame>
