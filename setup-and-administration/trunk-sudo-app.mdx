...
---
Trunk Sudo is a second Trunk GitHub App, separate from the [main Trunk GitHub App](/setup/integrations/github/trunk-app). Its only purpose is to programmatically merge pull requests while bypassing GitHub branch protections, on behalf of Trunk features that need that capability.
...
* The [main Trunk GitHub App](/setup/integrations/github/trunk-app) already installed
...
2. **Directly on GitHub:** Navigate to [https://github.com/apps/trunk-sudo](https://github.com/apps/trunk-sudo) and click **Install**.
...
→ For the main Trunk GitHub App and its permissions, see [Trunk GitHub App](/setup/integrations/github/trunk-app).
