...
<Frame>
  ![The Jobs list, one row per job with pass rate, duration, and run count](/assets/ci/ci-tab/jobs-list.jpeg)
</Frame>
...
<Frame>
  ![A job detail page, showing the pass rate, median duration, and retry figures over the run history chart](/assets/ci/ci-tab/job-performance.png)
</Frame>
