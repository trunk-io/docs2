...
description: "Automatically investigate and fix CI failures with Trunk's autofix agent."
og:title: "Autofix CI failures with Trunk"
---
...
<Frame>
![Configuration for Cursor Automation](/assets/flaky-tests/agents/ci-autofix-cursor-automation.png)
</Frame>
