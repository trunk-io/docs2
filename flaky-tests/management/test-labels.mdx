...
<Frame>
  <img className="block dark:hidden" src="/assets/test-details-labels-light.png" alt="Labels applied to a test on details page" />
  <img className="hidden dark:block" src="/assets/test-details-labels-dark.png" alt="Labels applied to a test on details page" />
</Frame>
...
<Info>
Any organization member can create, edit, assign, and unassign labels. Deleting a label requires organization admin access. The Delete option in each label's menu is disabled for non-admins.
</Info>
