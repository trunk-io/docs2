...
og:title: "Organizing tests with labels in Trunk Flaky Tests"
---
...
<Frame>
  <img className="block dark:hidden" src="/assets/flaky-tests/management/test-details-labels-light.png" alt="Labels applied to a test on details page" />
  <img className="hidden dark:block" src="/assets/flaky-tests/management/test-details-labels-dark.png" alt="Labels applied to a test on details page" />
</Frame>
...
<Frame>
![Settings page to manage test labels](/assets/flaky-tests/management/test-labels-settings.png)
</Frame>
...
<Frame>
![Label picker on test details page](/assets/flaky-tests/management/test-details-label-picker.png)
</Frame>
...
<Frame>
![Filter tests to those that have specified label applied](/assets/flaky-tests/management/tests-list-filtered-by-label.png)
</Frame>
