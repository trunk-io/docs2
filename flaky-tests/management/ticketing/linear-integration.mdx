...
<Frame>
<img className="block dark:hidden" src="/assets/linear-ticket-creation-light.png" alt="" />
<img className="hidden dark:block" src="/assets/linear-ticket-creation-dark.png" alt="" />
</Frame>
