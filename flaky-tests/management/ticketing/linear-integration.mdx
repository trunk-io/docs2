...
<Frame>
<img className="block dark:hidden" src="/assets/flaky-tests/management/ticketing/linear-integration-light.png" alt="" />
<img className="hidden dark:block" src="/assets/flaky-tests/management/ticketing/linear-integration-dark.png" alt="" />
</Frame>
...
<Frame>
<img className="block dark:hidden" src="/assets/flaky-tests/management/ticketing/linear-ticket-creation-light.png" alt="" />
<img className="hidden dark:block" src="/assets/flaky-tests/management/ticketing/linear-ticket-creation-dark.png" alt="" />
</Frame>
