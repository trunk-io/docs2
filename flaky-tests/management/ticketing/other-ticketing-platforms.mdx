...
<Frame>
<img className="block dark:hidden" src="/assets/flaky-tests/management/ticketing/manual-ticket-creation-light.png" alt="" />
<img className="hidden dark:block" src="/assets/flaky-tests/management/ticketing/manual-ticket-creation-dark.png" alt="" />
</Frame>
