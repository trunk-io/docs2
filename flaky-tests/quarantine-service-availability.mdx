---
title: "Quarantine Service Availability"
description: "Trunk Analytics CLI is designed to fail safe when our quarantine service is unavailable. Your CI pipeline's integrity is never compromised by Trunk outages."
---
### Service Availability and Graceful Degradation

[Trunk Analytics CLI](/flaky-tests/uploader) is designed to fail safe when our quarantine service is unavailable. Your CI pipeline's integrity is never compromised by Trunk outages.
