...
og:title: "Add the Trunk MCP server to Cursor"
---
## One-click setup
...
<Frame>
![](/assets/flaky-tests/reference/mcp-reference/configuration/Screenshot_2025-09-10_at_11.28.24_AM.png)
</Frame>
...
<Frame>
![](/assets/flaky-tests/reference/mcp-reference/configuration/Screenshot_2025-09-10_at_11.28.34_AM.png)
</Frame>
...
<Frame>
![](/assets/flaky-tests/reference/mcp-reference/configuration/Screenshot_2025-09-10_at_11.29.00_AM.png)
</Frame>
