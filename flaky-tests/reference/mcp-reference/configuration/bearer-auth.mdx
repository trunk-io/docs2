...
og:title: "Trunk MCP server bearer authentication"
---
...
Retrieve your organization's API token from the [settings page](https://app.trunk.io/settings) in the web app.
