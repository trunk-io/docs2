...
You can find your organization slug and token by navigating to **Settings** → **Manage** → **Organization**.
...
<img className="block dark:hidden" src="/assets/org-slug-light.png" alt="" />
<img className="hidden dark:block" src="/assets/org-slug-dark.png" alt="" />
</Frame>
</Tab>
<Tab title="Token">
<Frame caption="Ensure you get your Organization API Token, not your repo token.">
<img className="block dark:hidden" src="/assets/org-token-light.png" alt="" />
<img className="hidden dark:block" src="/assets/org-token-dark.png" alt="" />
</Frame>
</Tab>
</Tabs>
...
<img className="block dark:hidden" src="/assets/variants-light-border.png" alt="" />
<img className="hidden dark:block" src="/assets/variants-dark-border.png" alt="" />
</Frame>
