...
description: "Send flaky test alerts to Microsoft Teams using Trunk Flaky Tests webhooks."
og:title: "Microsoft Teams alerts with Trunk Flaky Tests webhooks"
---
...
4. Paste your Microsoft Teams Workflow URL from [the previous step ](./microsoft-teams-integration#1-configure-incoming-webhooks-for-your-team)into **Endpoint URL**.
5. Review the transformation code automatically generated for Teams messages. You can customize this transformation at any time. Learn more about [customizing transformations](./microsoft-teams-integration#3-customize-your-transformation).
...
3. You can test the transformation by selecting the `v2.test_case.status_changed` payload and clicking **Run Test**. This will test the transformation but not send a message. You will learn to send a test message in [step 4](./microsoft-teams-integration#4-test-your-webhook).
