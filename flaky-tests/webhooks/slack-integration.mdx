...
3.  Under **Organization > Webhooks**, click **Slack**
    ...
    <Frame>
    ![](/assets/example-webhook-connector-light.png)
    </Frame>
4.  Click **Connect to Slack** and select the server and channel to connect to.

    <Frame>
    ![](/assets/example-webhook-connector-slack_(1).png)
    </Frame>
5. Review the transformation code automatically generated for GitHub issues. You can customize this transformation at any time. Learn more about [customizing transformations](./slack-integration#id-2.-customize-your-transformation).
