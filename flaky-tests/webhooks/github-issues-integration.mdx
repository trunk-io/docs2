...
5.  Under **Permissions** > **Repository Permissions**, select **Read and Write** access for **Issues.**
    ...
    <Frame>
    <img className="block dark:hidden" src="/assets/example-webhook-github-permissions-light.png" alt="" />
    <img className="hidden dark:block" src="/assets/example-webhook-github-permissions-dark.png" alt="" />
    </Frame>
