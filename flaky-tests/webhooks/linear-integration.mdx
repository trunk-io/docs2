...
og:title: "Create Linear issues with Trunk Flaky Tests webhooks"
---
...
5. Review the transformation code automatically generated for Linear issues, you can customize this transformation at any time. Learn more about [customizing transformations](./linear-integration#5-customize-your-transformation).
...
You'll need your Linear API key from [step 1](./linear-integration#1-create-a-linear-personal-access-token).
...
3. You can test the transformation by selecting the `v2.test_case.status_changed` payload and clicking **Run Test**. This will test the transformation but not send a message. You will learn to send a test message[ in step 6](./linear-integration#6-test-your-webhook).
