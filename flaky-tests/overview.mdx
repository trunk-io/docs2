...
<img className="block dark:hidden" src="/assets/github-comment-light.png" alt="PR comment linking to PR Test Summary" />
<img className="hidden dark:block" src="/assets/github-comment-dark.png" alt="PR comment linking to PR Test Summary" />
</Frame>
...
<img className="block dark:hidden" src="/assets/override-light.png" alt="" />
<img className="hidden dark:block" src="/assets/override-dark.png" alt="" />
</Frame>
