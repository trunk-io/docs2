...
description: "Set up Trunk Flaky Tests by configuring test result output, uploading from CI, and enabling flake detection monitors."
og:title: "Getting started with Trunk Flaky Tests"
---
...
<Frame caption="Uploads tab">
<img className="block dark:hidden" src="/assets/flaky-tests/get-started/Screenshot_2025-11-11_at_3.58.16_PM.png" alt="" />
<img className="hidden dark:block" src="/assets/flaky-tests/get-started/Screenshot_2025-11-11_at_3.57.57_PM.png" alt="" />
</Frame>
