...
<img className="block dark:hidden" src="/assets/Screenshot_2025-11-11_at_3.58.16_PM.png" alt="" />
<img className="hidden dark:block" src="/assets/Screenshot_2025-11-11_at_3.57.57_PM.png" alt="" />
</Frame>
