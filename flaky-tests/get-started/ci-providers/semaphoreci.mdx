...
og:title: "Using Semaphore CI with Trunk Flaky Tests"
---
...
Store the Trunk slug and API token obtained in the previous step in your Semaphore CI Pipelines as new secrets named `TRUNK_ORG_URL_SLUG` and `TRUNK_TOKEN` respectively.
