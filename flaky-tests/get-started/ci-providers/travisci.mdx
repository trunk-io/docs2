...
og:title: "Using Travis CI with Trunk Flaky Tests"
---
...
Store the Trunk slug and API token obtained in the previous step as new secrets named `TRUNK_ORG_URL_SLUG` and `TRUNK_TOKEN` respectively.
