...
description: "Upload test results from Azure DevOps Pipelines to Trunk for flaky test detection."
og:title: "Using Azure DevOps Pipelines with Trunk Flaky Tests"
---
...
Store the Trunk slug and API token obtained in the previous step in your Azure DevOps Pipelines as new variables named `TRUNK_ORG_URL_SLUG` and `TRUNK_TOKEN` respectively.
