...
description: "Upload test results from Bitbucket Pipelines to Trunk for flaky test detection."
og:title: "Using BitBucket Pipelines with Trunk Flaky Tests"
---
...
Store the Trunk slug and API token obtained in the previous step in your BitBucket as a new variable named `TRUNK_ORG_URL_SLUG` and `TRUNK_TOKEN` respectively.
