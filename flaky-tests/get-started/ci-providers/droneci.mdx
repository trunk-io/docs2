...
og:title: "Using Drone CI with Trunk Flaky Tests"
---
...
Store your Trunk slug and API token in your Drone CI project settings as new variables named `TRUNK_ORG_URL_SLUG` and `TRUNK_TOKEN` respectively.
