...
---
Trunk Flaky Tests integrates with your CI by adding a step in your CircleCI Pipelines to upload tests with the [Trunk Uploader CLI](/flaky-tests/uploader).
...
See the [Uploader CLI Reference](/flaky-tests/uploader) for all available command line arguments and usage.
