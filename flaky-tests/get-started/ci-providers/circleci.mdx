...
og:title: "Using CircleCI with Trunk Flaky Tests"
---
...
Store your Trunk slug and API token in your CircleCI project settings under **Environment Variables** as new variables named `TRUNK_ORG_URL_SLUG` and `TRUNK_TOKEN` respectively.
    ...
    steps:
      ...
      - run:
          ...
          command: |
            ...
            ./trunk-analytics-cli upload --junit-paths "**/junit.xml" --org-url-slug <TRUNK_ORG_URL_SLUG> --token ${TRUNK_TOKEN}
```
```yaml Bazel
jobs:
  test-node:
