...
---
You can automatically [detect and manage flaky tests](/flaky-tests/detection) in your Swift projects by integrating with Trunk. This document explains how to configure Swift Testing to output JUnit XML reports that can be uploaded to Trunk for analysis.
