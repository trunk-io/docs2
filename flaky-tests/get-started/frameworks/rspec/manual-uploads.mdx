...
---
You can automatically [detect and manage flaky tests](/flaky-tests/detection) in your projects running RSpec by integrating with Trunk. This document explains how to configure RSpec to output JUnit XML reports that can be uploaded to Trunk for analysis.

<Warning>
We highly recommend using [Trunk's RSpec plugin](/flaky-tests/get-started/frameworks/rspec) to upload test results for the best accuracy when detecting flaky tests.
</Warning>
