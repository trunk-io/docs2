...
<Frame caption="The Choose quarantine status control on a test's details page, set to Always.">
  <img className="block dark:hidden" src="/assets/qurantine-individual-tests-light.png" alt="quarantine override on the test details page" />
  <img className="hidden dark:block" src="/assets/qurantine-individual-tests-dark.png" alt="quarantine override on the test details page" />
</Frame>
