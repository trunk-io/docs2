...
A new [test collection](../test-collections) starts with quarantining enabled. To change it, navigate to **Flaky Tests** → **Collections** → **[collection]** → **Settings** → **Quarantining**.
