...
Add the following [configuration](https://github.com/google-gemini/gemini-cli/blob/v0.1.19/docs/tools/mcp-server#oauth-support-for-remote-mcp-servers) to your project's `.gemini/settings.json` file.
