...
description: "Trunk Flaky Tests detects flaky tests by analyzing test results from your CI runs. Setup requires configuring test result output and CI upload integration."
---
...
* See [**Test Frameworks**](/flaky-tests/get-started/frameworks) for framework-specific configuration
...
1. See [**CI Providers**](/flaky-tests/get-started/ci-providers) for integration instructions
...
<figure><picture><source srcset="https://577236045-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F61Ep9MrYBkJa0Yq3zS1s%2Fuploads%2Fgit-blob-d454beb56d9c7ac46ed2774a048a9b07fadb2ddc%2FScreenshot%202025-11-11%20at%203.57.57%E2%80%AFPM.png?alt=media" media="(prefers-color-scheme: dark)" /><img src="https://577236045-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F61Ep9MrYBkJa0Yq3zS1s%2Fuploads%2Fgit-blob-b1cffb30755ceb2f34d9804ffb66b92ef30d552b%2FScreenshot%202025-11-11%20at%203.58.16%E2%80%AFPM.png?alt=media" alt="" /></picture><figcaption><p>Uploads tab</p></figcaption></figure>
...
[How failure rate monitors work →](/flaky-tests/detection/failure-rate-monitor)
...
[Configure Quarantining →](/flaky-tests/quarantining)
