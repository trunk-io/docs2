...
<Update label="June 3, 2026" tags={["Flaky Tests"]}>
  **[Flaky Tests: Monitor Disable and Delete Events in Test History](/changelog/2026-06-03-flaky-tests-monitor-disable-delete-events)**

  Disabling or deleting a monitor now writes a deactivation event visible in each affected test's Events tab.
</Update>
