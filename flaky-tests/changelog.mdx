...
<Update label="June 24, 2026" tags={["Flaky Tests"]}>
  **[Flaky Tests: Detect and Resolve API Endpoints for Test Collection Monitors](/changelog/2026-06-24-flaky-tests-test-collection-api-endpoints)**

  New REST endpoints let you trigger detection and resolution on test collections for failure-count, skipped-test, and slow-test monitors.
</Update>
