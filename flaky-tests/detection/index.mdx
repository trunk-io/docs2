...
**Default state** below is what a new [test collection](../test-collections#what-a-new-collection-starts-with) starts with. On a repository, only pass-on-retry is enabled.
