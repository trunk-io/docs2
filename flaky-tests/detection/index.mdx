...
The **Default state** column below describes a repository. A new [test collection](../test-collections#what-a-new-collection-starts-with) is seeded with pass-on-retry, failure count, failure rate, new test, and skipped test already enabled.
