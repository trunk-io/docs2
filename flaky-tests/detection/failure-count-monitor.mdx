...
og:title: "The Failure Count Monitor in Trunk Flaky Tests"
---
...
Branch patterns work the same way as [failure rate monitor branch patterns](./failure-rate-monitor#branch-scope), including glob syntax and merge queue patterns. Refer to that section for pattern syntax, examples, and tips.
