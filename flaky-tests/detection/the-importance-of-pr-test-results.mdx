...
description: "Why uploading test results from pull requests is required for accurate flaky test detection, quarantining, and impact measurement."
og:title: "Why PR test results matter for Trunk Flaky Tests"
---
...
* Actionable Exit Codes: The CLI intelligently determines the job's outcome.
  ...
  * When _only_ a known flaky test fails, it passes the job: `All test failures were quarantined, overriding exit code to be exit_success`
