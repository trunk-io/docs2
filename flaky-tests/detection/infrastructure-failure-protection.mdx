...
description: "Prevent false Trunk Flaky Tests detections during CI outages and infrastructure failures."
og:title: "Infrastructure failure protection in Trunk Flaky Tests"
---
...
<Frame>
![Configuration for Infrastructure Failure Protection and Failure Threshold](/assets/flaky-tests/detection/image_(1).png)
</Frame>
