...
6. **Existing docs**: Use `mcp__claude_ai_trunk_docs__searchDocumentation`, Glob, and Grep. Read `docs.json` for the site navigation and group structure.
...
10. Write or edit documentation:
   ...
   - Update `docs.json` if adding new pages (insert the page path, without the `.mdx` extension, into the relevant `groups[].pages` array)
